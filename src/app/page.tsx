        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-16">
            <Link
              ...
              className="px-8 py-4 bg-[#57C84D] text-white font-bold text-lg rounded-2xl hover:bg-green-600 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              Launch App
            </Link>
            <Link
